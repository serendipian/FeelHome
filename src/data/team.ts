...
export const TEAM_DISPLAY: Record<string, TeamMemberDisplay> = {
  ...
  'community-mgr': { id: 'community-mgr', initials: 'CM', color: '#9a6b3a', subtitle: 'Content & Social', scope: 'Expats.ma', location: undefined },
  'property-hunter': { id: 'property-hunter', initials: 'PH', color: '#9a6b3a', subtitle: 'Sourcing', scope: 'Sourcing', location: undefined },
  'customer-service': { id: 'customer-service', initials: 'CS', color: '#9a6b3a', subtitle: 'Support', scope: 'All Brands', location: undefined },
  'community-manager': { id: 'community-manager', initials: 'MK', color: '#d4a853', subtitle: 'Branding & Partnerships', scope: 'Marketing', location: undefined },
