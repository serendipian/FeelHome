...
export default function Toggle({ checked, onChange, color }: ToggleProps) {
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: checked ? color : (isDark ? 'rgba(255,255,255,0.06)' : 'rgba(15,23,42,0.08)'),
        boxShadow: checked ? `0 0 16px ${color}30, inset 0 1px 2px rgba(0,0,0,0.2)` : (isDark ? 'inset 0 1px 3px rgba(0,0,0,0.3)' : 'inset 0 1px 3px rgba(15,23,42,0.1)'),
      }}
    >
      <span
        ...
        style={{
          ...
          background: checked ? '#fff' : (isDark ? 'rgba(255,255,255,0.3)' : 'rgba(15,23,42,0.25)'),
